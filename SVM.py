...
SVR_mrse = mean_squared_error(y_test, y_pred_SVR)
# ---------------------------------------------------LinearSVR----------------------------------------------------------
# Select parameter
# cv_params = {'C': [0.4, 0.5, 0.6, 0.7, 0.8, 1, 2, 5, 9, 10]}
# other_params = {'C': 0.6, 'max_iter': 100000}
#
...
lin_SVR_mrse = mean_squared_error(y_test, y_pred_lin_SVR)
# ----------------------------------------------------------------Output------------------------------------------------
